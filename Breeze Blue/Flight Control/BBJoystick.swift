...
protocol BBJoystickViewModelProtocol: class {
    func touchesBegan()
    func touchesEnded()
...
final class BBJoystick: UIControl {
    private static let JSIZE: CGFloat = 80.0

    var viewModel: BBJoystickViewModelProtocol?
    ...
    init(frame: CGRect, viewModel: BBJoystickViewModelProtocol) {
...
extension BBJoystick: BBJoystickViewModelDelegate {
    func didUpdate() {
        updateUI()
    }
}

extension BBJoystick: CAAnimationDelegate {
