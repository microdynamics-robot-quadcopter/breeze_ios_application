...
protocol BBJoystickViewModelDelegate: class {
    func didUpdate()
}

public protocol BBJoystickViewModelObserver: BBObserver {
    func didUpdateState()
}

final class BBJoystickViewModel: BBJoystickViewModelProtocol, BBObservable, BreezeBlueXProvideable, BreezeBlueYProvideable  {
    typealias ConcreteObserver = BBJoystickViewModelObserver

    var weakObservers: [WeakBox] = [WeakBox]()
    weak var delegate: BBJoystickViewModelDelegate?
