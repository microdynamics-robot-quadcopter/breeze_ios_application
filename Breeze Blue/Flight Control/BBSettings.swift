...
enum ControlMode: Int {
    ...
    func commander(leftJoystick: BBJoystickViewModel?,
                   rightJoystick: BBJoystickViewModel?,
                   motionLink: BBMotionLink? = nil,
                   settings: Settings?) -> BreezeBlueCommander? {
        ...
        case .mode1:
            ...
            commander = SimpleBreezeBlueCommander(
